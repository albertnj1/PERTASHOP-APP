            ...
            <div class="card card-primary card-outline card-outline-tabs">
                <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" id="investor-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="tab-investasi" data-toggle="pill" href="#content-investasi" role="tab" aria-controls="content-investasi" aria-selected="false">Data Investasi</a>
                        </li>
                    </ul>
                </div>

                <form id="insertForm" action="{{ route('investors.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    <div class="card-body">
                        <div class="tab-content" id="investor-tabs-content">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nama_lengkap_gelar') is-invalid @enderror" id="nama_lengkap_gelar" name="nama_lengkap_gelar" value="{{ old('nama_lengkap_gelar') }}" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('alamat_domisili') is-invalid @enderror" id="alamat_domisili" name="alamat_domisili" rows="3" required>{{ old('alamat_domisili') }}</textarea>
                                            @error('alamat_domisili')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
                                            <small class="text-muted">Alamat Saat Ini Tinggal</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control @error('email_pribadi') is-invalid @enderror" id="email_pribadi" name="email_pribadi" value="{{ old('email_pribadi') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="text-muted">Digunakan untuk keperluan transfer pembagian dividen.</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nomor_npwp') is-invalid @enderror" id="nomor_npwp" name="nomor_npwp" value="{{ old('nomor_npwp') }}">
                            ...
                            <!-- Tab Data Investasi -->
                            <div class="tab-pane fade" id="content-investasi" role="tabpanel" aria-labelledby="tab-investasi">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5 class="text-primary border-bottom pb-2 mb-3">Penempatan Investasi Awal</h5>
                                        <div class="form-group">
                                            <label for="shop_id">Pertashop (Lokasi Investasi) <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label for="nominal">Nominal Investasi (Rupiah) <span class="text-danger">*</span></label>
                                            ...
                                            <small class="text-muted">Persentase saham akan dihitung secara otomatis oleh sistem (Nominal / Modal Awal Pertashop * 100).</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer bg-white border-top text-right">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save mr-1"></i> Simpan Investor</button>
                    </div>
                </form>
            </div>
        </div>

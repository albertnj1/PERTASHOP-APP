    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary card-outline card-outline-tabs">
                ...
                <form id="insertForm" action="{{ route('operators.store') }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                    @csrf
                    <div class="card-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="shop_id" id="shop_id" class="form-control @error('shop_id') is-invalid @enderror" required>
                                                ...
                                                @foreach ($shops as $shop)
                                                    <option value="{{ $shop->id }}" @selected($shop->id == old('shop_id'))>{{ $shop->kode }} {{ $shop->nama }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('kewarganegaraan') is-invalid @enderror" id="kewarganegaraan" name="kewarganegaraan" value="{{ old('kewarganegaraan', 'WNI') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('status_hubungan') is-invalid @enderror" id="status_hubungan" name="status_hubungan" required>
                                                <option value="">-- Pilih --</option>
                                                <option value="Kepala Keluarga" @selected(old('status_hubungan') == 'Kepala Keluarga')>Kepala Keluarga</option>
                                                ...
                                                <option value="Famili Lain" @selected(old('status_hubungan') == 'Famili Lain')>Famili Lain</option>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control @error('email_pribadi') is-invalid @enderror" id="email_pribadi" name="email_pribadi" value="{{ old('email_pribadi') }}" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('akun_medsos') is-invalid @enderror" id="akun_medsos" name="akun_medsos" value="{{ old('akun_medsos') }}" placeholder="Instagram: @username, FB: Nama">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('atas_nama_rekening') is-invalid @enderror" id="atas_nama_rekening" name="atas_nama_rekening" value="{{ old('atas_nama_rekening') }}" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('pendidikan_terakhir') is-invalid @enderror" id="pendidikan_terakhir" name="pendidikan_terakhir" value="{{ old('pendidikan_terakhir') }}" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('golongan_darah') is-invalid @enderror" id="golongan_darah" name="golongan_darah" required>
                                                ...
                                                <option value="Belum Tahu" @selected(old('golongan_darah') == 'Belum Tahu')>Belum Tahu</option>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nomor_paspor') is-invalid @enderror" id="nomor_paspor" name="nomor_paspor" value="{{ old('nomor_paspor') }}">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <select name="jenis_sim" id="jenis_sim" class="form-control @error('jenis_sim') is-invalid @enderror">
                                                        ...
                                                        <option value="A" @selected(old('jenis_sim') == 'A')>A</option>
                                                        <option value="B" @selected(old('jenis_sim') == 'B')>B</option>
                                                        <option value="C" @selected(old('jenis_sim') == 'C')>C</option>
                                                    </select>
                                                </div>
                                                <input type="text" class="form-control @error('nomor_sim') is-invalid @enderror" id="nomor_sim" name="nomor_sim" value="{{ old('nomor_sim') }}">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nomor_bpjs') is-invalid @enderror" id="nomor_bpjs" name="nomor_bpjs" value="{{ old('nomor_bpjs') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nomor_npwp') is-invalid @enderror" id="nomor_npwp" name="nomor_npwp" value="{{ old('nomor_npwp') }}" required>
                    ...
                    <div class="card-footer bg-white border-top text-right">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save mr-1"></i> Simpan Operator</button>
                    </div>
                </form>
            </div>
        </div>

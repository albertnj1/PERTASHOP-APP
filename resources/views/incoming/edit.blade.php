                ...
                <form id="insertForm" action="{{ route('incomings.update', $incoming->id) }}" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control @error('incoming_date') is-invalid @enderror"
                                    id="incoming_date" name="incoming_date" value="{{ old('incoming_date', $incoming->incoming_date ? \Carbon\Carbon::parse($incoming->incoming_date)->format('Y-m-d') : ($incoming->created_at ? \Carbon\Carbon::parse($incoming->created_at)->format('Y-m-d') : date('Y-m-d'))) }}">
                                @error('incoming_date')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control @error('asal_pengirim') is-invalid @enderror"
                                    id="asal_pengirim" name="asal_pengirim" value="{{ old('asal_pengirim', $incoming->asal_pengirim) }}">
                                @error('asal_pengirim')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="number" step="0.01" class="form-control" id="maos_volume" name="maos_volume" value="{{ old('maos_volume', $incoming->maos_volume) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" step="0.01" class="form-control" id="maos_suhu" name="maos_suhu" value="{{ old('maos_suhu', $incoming->maos_suhu) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="maos_density" class="col-sm-4 col-form-label">Density</label>
                            <div class="col-sm-8">
                                <input type="number" step="0.01" class="form-control" id="maos_density" name="maos_density" value="{{ old('maos_density', $incoming->maos_density) }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="time" class="form-control" id="jam_berangkat" name="jam_berangkat" value="{{ old('jam_berangkat', $incoming->jam_berangkat ? \Carbon\Carbon::parse($incoming->jam_berangkat)->format('H:i') : '') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="jam_tiba" class="col-sm-4 col-form-label">Jam Tiba</label>
                            <div class="col-sm-8">
                                <input type="time" class="form-control" id="jam_tiba" name="jam_tiba" value="{{ old('jam_tiba', $incoming->jam_tiba ? \Carbon\Carbon::parse($incoming->jam_tiba)->format('H:i') : '') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" step="0.01" class="form-control" id="stock_terima_bbm" name="stock_terima_bbm" value="{{ old('stock_terima_bbm', $incoming->stock_terima_bbm) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="dens_temp" class="col-sm-4 col-form-label">Dens/Temp</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="dens_temp" name="dens_temp" value="{{ old('dens_temp', $incoming->dens_temp) }}">
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="input-group">
                                            <input type="number" step="0.01" class="form-control @error('stik_awal') is-invalid @enderror" id="stik_awal" name="stik_awal" value="{{ old('stik_awal', $incoming->stik_awal) }}">
                                    ...
                                    <div class="col-6">
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="stok_awal" name="stok_awal" value="{{ old('stok_awal', $incoming->stik_awal * $shop->skala) }}" readonly>
                                            <div class="input-group-append"><span class="input-group-text">&ell;</span></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="input-group">
                                            <input type="number" step="0.01" class="form-control @error('stik_akhir') is-invalid @enderror" id="stik_akhir" name="stik_akhir" value="{{ old('stik_akhir', $incoming->stik_akhir) }}">
                                            <div class="input-group-append"><span class="input-group-text">cm</span></div>
                                        </div>
                                        @error('stik_akhir')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                    ...
                                    <div class="col-6">
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="stok_akhir" name="stok_akhir" value="{{ old('stok_akhir', $incoming->stik_akhir * $shop->skala) }}" readonly>
                                            <div class="input-group-append"><span class="input-group-text">&ell;</span></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="number" step="0.01" class="form-control @error('penerimaan_real') is-invalid @enderror" id="penerimaan_real" name="penerimaan_real" value="{{ old('penerimaan_real', $incoming->penerimaan_real ?? ($incoming->stik_akhir - $incoming->stik_awal) * $shop->skala) }}" readonly style="background-color: #e8f5e9; font-weight: bold;">
                                    <div class="input-group-append"><span class="input-group-text">&ell;</span></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="number" step="0.01" class="form-control" id="terima_volume" name="terima_volume" value="{{ old('terima_volume', $incoming->terima_volume) }}">
                                    <div class="input-group-append"><span class="input-group-text">&ell;</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" step="0.01" class="form-control" id="terima_suhu" name="terima_suhu" value="{{ old('terima_suhu', $incoming->terima_suhu) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="terima_density" class="col-sm-4 col-form-label">Density Terima</label>
                            <div class="col-sm-8">
                                <input type="number" step="0.01" class="form-control" id="terima_density" name="terima_density" value="{{ old('terima_density', $incoming->terima_density) }}">
                            </div>
                        </div>
...
@push('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            // Trigger events on load to show initial states if populated
            if($('#terima_suhu').val()) $('#terima_suhu').trigger('input');
            if($('#stik_akhir').val()) $('#stik_akhir').trigger('input');
        })
    </script>
@endpush

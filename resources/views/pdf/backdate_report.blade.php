                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr class="table-total">
                            ...
                            <td class="text-right">Rp {{ number_format($subtotal_aset ?? 0, 0, ',', '.') }}</td>
                        </tr>
                    </tbody>
                </table>
            </td>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right" style="color: #b91c1c;">-Rp {{ number_format(abs($pajak_bank ?? 0), 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right" style="color: #b91c1c;">-Rp {{ number_format(abs($saldo_dibagi ?? 0), 0, ',', '.') }}</td>
                        </tr>
            ...
            @if(isset($modal_history) && count($modal_history) > 0)
                @foreach($modal_history as $idx => $hist)
                    <tr>
                        ...
                        <td class="text-right" style="color: #b91c1c;">-Rp {{ number_format(abs($hist['tax_fee'] ?? 0), 0, ',', '.') }}</td>

...
<style>
  ...
  *{ box-sizing:border-box; }
  ...
  .bg{
    ...
    background-image: url('{{ asset('images/PERTASHOP PAGE.png') }}?v={{ time() }}');
    ...
    <div class="card-inner">
      ...
      <div class="badge-wrap">
        <div class="badge" style="background: transparent; border: none; box-shadow: none;">
          <img src="{{ asset('images/logo-pertashop.png') }}" alt="Pertashop Logo" style="width: 80px; height: auto; object-fit: contain;">
        </div>
        <h1>SIPERI</h1>

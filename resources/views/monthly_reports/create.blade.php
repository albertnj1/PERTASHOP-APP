                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="saldo_awal_modal" id="saldo_awal_modal" class="form-control" value="{{ number_format(old('saldo_awal_modal', $lastSaldoModal), 0, '', '') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="sisa_do_volume" class="form-label">Sisa DO Pertamina (Liter)</label>
                                        <div class="input-group">
                                            <input type="number" step="0.01" name="sisa_do_volume" id="sisa_do_volume" class="form-control" value="{{ old('sisa_do_volume', 0) }}" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" name="kas_kecil" id="kas_kecil" class="form-control" value="{{ old('kas_kecil', 0) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" name="piutang" id="piutang" class="form-control" value="{{ old('piutang', 0) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" name="bunga_bank" id="bunga_bank" class="form-control" value="{{ old('bunga_bank', 0) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" name="pajak_bank" id="pajak_bank" class="form-control" value="{{ old('pajak_bank', 0) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" name="penyusutan_modal" id="penyusutan_modal" class="form-control" value="{{ old('penyusutan_modal', 0) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" name="penambahan_modal" id="penambahan_modal" class="form-control" value="{{ old('penambahan_modal', 0) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" name="harga_beli_pertamax" id="harga_beli_pertamax" class="form-control" value="{{ old('harga_beli_pertamax', 0) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" name="saldo_laba_sebelumnya" id="saldo_laba_sebelumnya" class="form-control" value="{{ old('saldo_laba_sebelumnya', 0) }}" required>
                                        </div>

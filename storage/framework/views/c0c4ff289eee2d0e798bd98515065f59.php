...
<style>
  ...
  .kpi-emerald .kpi-icon-wrapper {
    background: #ecfdf5;
    color: #059669;
  }

  .kpi-indigo .kpi-icon-wrapper {
    background: #eef2ff;
    color: #4f46e5;
  }

  .kpi-cyan .kpi-icon-wrapper {
    background: #ecfeff;
    color: #0891b2;
  }

  .kpi-amber .kpi-icon-wrapper {
    background: #fffbeb;
    color: #d97706;
  }

  .kpi-rose .kpi-icon-wrapper {
    background: #fff1f2;
    color: #e11d48;
  }
  ...
  <div class="excel-viewer-card">
    ...
    <div id="excel-summary-container" class="p-4" style="display: none; background: #ffffff;">
      ...
      <div class="row">
            ...
            <div class="card-body p-0" style="max-height: 280px; overflow-y: auto;">
              <table class="table table-sm table-striped table-hover mb-0" style="font-size: 12px;">
                ...
                <tbody id="table-tp-body">
                  <?php $__empty_1 = true;
                  $__currentLoopData = $sum['test_pump']['details'];
                  $__env->addLoop($__currentLoopData);
                  foreach ($__currentLoopData as $idx => $tp): $__env->incrementLoopIndices();
            ...
            <div class="card-body p-0" style="max-height: 280px; overflow-y: auto;">
              <table class="table table-sm table-striped table-hover mb-0" style="font-size: 12px;">
                ...
                <tbody id="table-bbm-body">
                  <?php $__empty_1 = true;
                  $__currentLoopData = $sum['pembelian_bbm']['details'];
                  $__env->addLoop($__currentLoopData);
                  foreach ($__currentLoopData as $idx => $bbm): $__env->incrementLoopIndices();
                    $loop = $__env->getLastLoop();
                    $__empty_1 = false; ?>
                    <tr>
                      <td class="text-center"><?php echo e($idx + 1); ?></td>
          ...
          <div class="card shadow-sm border" style="border-radius: 10px; overflow: hidden;">
            ...
            <div class="card-body p-3">
              ...
              <div class="mb-3 d-flex flex-wrap" id="pengeluaran-category-pills">
                <?php $__currentLoopData = $sum['total_pengeluaran']['category_totals'];
                $__env->addLoop($__currentLoopData);
                foreach ($__currentLoopData as $catName => $catVal): $__env->incrementLoopIndices();
                  $loop = $__env->getLastLoop(); ?>
              ...
              <div style="max-height: 320px; overflow-y: auto;" class="border rounded">
                <table class="table table-sm table-striped table-hover mb-0" style="font-size: 12px;">
                  ...
                  <tbody id="table-pengeluaran-body">
                    <?php $__empty_1 = true;
                    $__currentLoopData = $sum['total_pengeluaran']['details'];
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $idx => $sp): $__env->incrementLoopIndices();
                      $loop = $__env->getLastLoop();
                      $__empty_1 = false; ?>
                      <tr>
                        <td class="text-center"><?php echo e($idx + 1); ?></td>
            ...
            <div class="card-body p-0" style="max-height: 320px; overflow-y: auto;">
              <table class="table table-sm table-striped table-hover mb-0" style="font-size: 12px;">
                ...
                <tbody id="table-belum-disetor-body">
                  <?php $__empty_1 = true;
                  $__currentLoopData = $sum['total_belum_disetorkan']['details'];
                  $__env->addLoop($__currentLoopData);
                  foreach ($__currentLoopData as $idx => $bd): $__env->incrementLoopIndices();
                    $loop = $__env->getLastLoop();
                    $__empty_1 = false; ?>
                    <tr>
                      <td class="text-center"><?php echo e($idx + 1); ?></td>
        ...
        <?php if (isset($sum['profit_sharing']) && is_array($sum['profit_sharing'])): ?>
          <?php $ps = $sum['profit_sharing']; ?>
          <?php $investorDetails = $ps['investor_details'] ?? []; ?>
          <div class="col-md-12 mb-4">
            <div class="card shadow-sm border" style="border-radius: 12px; overflow: hidden; border-color: #cbd5e1 !important;">
              <div class="card-header d-flex align-items-center justify-content-between py-2.5" style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); color: #ffffff;">
                ...
                <span class="badge badge-warning text-dark font-weight-bold px-2.5 py-1" style="font-size: 11.5px; border-radius: 6px;">
                  Total Bagi Hasil: Rp <?php echo e(number_format($ps['laba_bersih_dibagi'] ?? 0, 0, ',', '.')); ?>
              ...
              <div class="card-body p-3 bg-light">
                ...
                <div class="row mb-3">
                  <div class="col-md-3 mb-2">
                    <div class="p-2.5 bg-white border rounded shadow-xs">
                      <small class="text-muted d-block text-uppercase font-weight-bold" style="font-size: 10px;">Estimasi Laba Kotor (Margin Rp <?php echo e(number_format($ps['margin_per_liter'] ?? 0, 2, ',', '.')); ?>/L)</small>
                      <span class="h6 font-weight-bold text-success mb-0">Rp <?php echo e(number_format($ps['est_laba_kotor'] ?? 0, 0, ',', '.')); ?></span>
                    </div>
                  </div>
                  <div class="col-md-3 mb-2">
                    <div class="p-2.5 bg-white border rounded shadow-xs">
                      <small class="text-muted d-block text-uppercase font-weight-bold" style="font-size: 10px;">Total Pengeluaran &amp; Test Pump</small>
                      <span class="h6 font-weight-bold text-danger mb-0">Rp <?php echo e(number_format($ps['total_pengeluaran'] ?? 0, 0, ',', '.')); ?></span>
                    </div>
                  </div>
                  <div class="col-md-3 mb-2">
                    <div class="p-2.5 bg-white border rounded shadow-xs">
                      <small class="text-muted d-block text-uppercase font-weight-bold" style="font-size: 10px;">Cadangan Modal (<?php echo e($ps['persen_alokasi_modal'] ?? 0); ?>%)</small>
                      <span class="h6 font-weight-bold text-info mb-0">Rp <?php echo e(number_format($ps['alokasi_modal'] ?? 0, 0, ',', '.')); ?></span>
                    </div>
                  </div>
                  <div class="col-md-3 mb-2">
                    <div class="p-2.5 bg-white border rounded shadow-xs" style="border-left: 4px solid #10b981 !important;">
                      ...
                      <span class="h6 font-weight-bold text-dark mb-0">Rp <?php echo e(number_format($ps['laba_bersih_dibagi'] ?? 0, 0, ',', '.')); ?></span>
                    </div>
                  </div>
                </div>
                ...
                <div class="border rounded bg-white overflow-hidden" style="max-height: 350px; overflow-y: auto;">
                  <table class="table table-sm table-striped table-hover mb-0" style="font-size: 12.5px;">
                    ...
                    <tbody>
                      <?php $__empty_1 = true;
                      $__currentLoopData = $investorDetails;
                      $__env->addLoop($__currentLoopData);
                      foreach ($__currentLoopData as $idx => $inv): $__env->incrementLoopIndices();
                        $loop = $__env->getLastLoop();
                        $__empty_1 = false; ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <span class="badge badge-info px-2 py-1" style="font-size: 11.5px; border-radius: 4px;">
                              <?php echo e(number_format($inv['persentase'] ?? 0, 2, ',', '.')); ?>%
                            </span>
                          </td>
                          <td class="text-right font-weight-bold text-muted">
                            Rp <?php echo e(number_format($inv['nominal_modal'] ?? 0, 0, ',', '.')); ?>

                          </td>
                          <td class="text-right font-weight-bold text-success" style="font-size: 13px;">
                            Rp <?php echo e(number_format($inv['nominal_share'] ?? 0, 0, ',', '.')); ?>

...
<body
    class="hold-transition <?php echo e(Auth::user()->role == 'operator' ? 'layout-top-nav' : 'sidebar-mini layout-fixed layout-navbar-fixed'); ?>">

    <?php if(Auth::user()->role == 'operator'): ?>
        <?php echo $__env->make('layouts._operator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php else: ?>
        <?php echo $__env->make('layouts._admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\Pertashop App_Laravel\sal-pertashop\resources\views/layouts/app.blade.php ENDPATH**/ ?>
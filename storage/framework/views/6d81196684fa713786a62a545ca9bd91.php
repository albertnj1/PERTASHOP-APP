...
<head>
    <meta charset="UTF-8">
    <title>Laporan Resmi - <?php echo e($outlet_name ?? ($data['outlet_name'] ?? 'Pertashop')); ?></title>
    <style>
...
<body>
        ...
        <table style="margin: 0; border: none;">
            <tr>
                <td style="border: none; padding: 0;" class="text-left">
                    ...
                    <div class="outlet-info"><?php echo e($outlet_name ?? 'Pertashop'); ?> (Kode: <?php echo e($outlet_code ?? '-'); ?>) • Periode: <?php echo e($period ?? 'Bulan Berjalan'); ?></div>
                </td>
                ...
                <div class="card">
                    ...
                    <table style="margin: 0;">
                        <tr>
                            ...
                            <td style="border: none; padding: 2px 0;" class="text-right font-bold">Rp <?php echo e(number_format($hpp ?? 0, 2, ',', '.')); ?></td>
                        </tr>
                        <tr>
                            <td style="border: none; padding: 2px 0;">Harga Jual Eceran</td>
                            <td style="border: none; padding: 2px 0;" class="text-right font-bold">Rp <?php echo e(number_format($harga_jual ?? 0, 2, ',', '.')); ?></td>
                        </tr>
                        <tr>
                            <td style="border: none; padding: 2px 0; color: #166534;">Margin per Liter</td>
                            <td style="border: none; padding: 2px 0; color: #166534;" class="text-right font-bold">Rp <?php echo e(number_format(($harga_jual ?? 0) - ($hpp ?? 0), 2, ',', '.')); ?></td>
                        </tr>
                    </table>
                </div>
            </td>
                ...
                <div class="card card-highlight">
                    ...
                    <table style="margin: 0;">
                        <tr>
                            ...
                            <td style="border: none; padding: 2px 0;" class="text-right font-bold"><?php echo e(number_format($total_liter ?? 0, 2, ',', '.')); ?> ℓ</td>
                        </tr>
                        <tr>
                            <td style="border: none; padding: 2px 0;">Rata-rata Omset Harian</td>
                            <td style="border: none; padding: 2px 0;" class="text-right font-bold"><?php echo e(number_format($omset_harian ?? 0, 2, ',', '.')); ?> ℓ/hari</td>
                        </tr>
                        <tr>
                            <td style="border: none; padding: 2px 0;">Grand Total Laba Kotor</td>
                            <td style="border: none; padding: 2px 0; color: #166534;" class="text-right font-bold">Rp <?php echo e(number_format($laba_kotor ?? 0, 0, ',', '.')); ?></td>
                        </tr>
                    </table>
                </div>
            </td>
    ...
    <table>
        ...
        <tbody>
            <?php if(isset($batches) && count($batches) > 0): ?>
                <?php $__currentLoopData = $batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="table-subtotal">
                        <td colspan="4">BATCH PEMBELIAN #<?php echo e($index + 1); ?> (HPP: Rp <?php echo e(number_format($b['hpp'] ?? 0, 2, ',', '.')); ?> | Jual: Rp <?php echo e(number_format($b['jual'] ?? 0, 2, ',', '.')); ?>)</td>
                    </tr>
                    <tr>
                        <td>a. Stok Awal Tangki</td>
                        <td>Fisik Awal Periode</td>
                        <td class="text-right"><?php echo e(number_format($b['stok_awal'] ?? 0, 2, ',', '.')); ?> ℓ</td>
                        <td class="text-right">Rp <?php echo e(number_format(($b['stok_awal'] ?? 0) * ($b['hpp'] ?? 0), 0, ',', '.')); ?></td>
                    </tr>
                    <tr>
                        <td>b. BBM Datang (DO)</td>
                        <td>Penerimaan Tangki Pertamina</td>
                        <td class="text-right"><?php echo e(number_format($b['do_masuk'] ?? 0, 2, ',', '.')); ?> ℓ</td>
                        <td class="text-right">Rp <?php echo e(number_format(($b['do_masuk'] ?? 0) * ($b['hpp'] ?? 0), 0, ',', '.')); ?></td>
                    </tr>
                    <tr>
                        <td>c. Penjualan Bersih</td>
                        <td>Totalisator - Test Pump</td>
                        <td class="text-right font-bold"><?php echo e(number_format($b['liter_terjual'] ?? 0, 2, ',', '.')); ?> ℓ</td>
                        <td class="text-right font-bold">Rp <?php echo e(number_format(($b['liter_terjual'] ?? 0) * ($b['jual'] ?? 0), 0, ',', '.')); ?></td>
                    </tr>
                    <tr>
                        <td>d. Sisa Stok Akhir</td>
                        <td>Fisik Akhir / Sisa Tangki</td>
                        <td class="text-right"><?php echo e(number_format($b['stok_akhir'] ?? 0, 2, ',', '.')); ?> ℓ</td>
                        <td class="text-right">Rp <?php echo e(number_format(($b['stok_akhir'] ?? 0) * ($b['hpp'] ?? 0), 0, ',', '.')); ?></td>
                    </tr>
                    <tr style="background: #f0fdf4;">
                        <td colspan="3" class="font-bold text-right" style="color: #166534;">Subtotal Laba Kotor Batch #<?php echo e($index + 1); ?></td>
                        <td class="text-right font-bold" style="color: #166534;">Rp <?php echo e(number_format($b['laba_kotor'] ?? 0, 0, ',', '.')); ?></td>
                    </tr>
            ...
            <?php else: ?>
                <tr>
                    ...
                    <td class="text-right"><?php echo e(number_format($total_liter ?? 0, 2, ',', '.')); ?> ℓ</td>
                    <td class="text-right">Rp <?php echo e(number_format(($total_liter ?? 0) * ($hpp ?? 0), 0, ',', '.')); ?></td>
                </tr>
                <tr>
                    <td>Penjualan Bersih</td>
                    <td>Totalisator Dispenser</td>
                    <td class="text-right font-bold"><?php echo e(number_format($total_liter ?? 0, 2, ',', '.')); ?> ℓ</td>
                    <td class="text-right font-bold">Rp <?php echo e(number_format(($total_liter ?? 0) * ($harga_jual ?? 0), 0, ',', '.')); ?></td>
                </tr>
            <?php endif; ?>
            <tr class="table-total">
                <td colspan="3" class="text-right">GRAND TOTAL LABA KOTOR OPERASIONAL</td>
                <td class="text-right text-primary">Rp <?php echo e(number_format($laba_kotor ?? 0, 0, ',', '.')); ?></td>
            </tr>
        </tbody>
    </table>

    <div class="doc-footer">
        Dokumen ini dibuat otomatis oleh Sistem Informasi Pertashop • Dicetak pada <?php echo e(date('d/m/Y H:i')); ?> WIB
    </div>
        ...
        <table style="margin: 0; border: none;">
            <tr>
                <td style="border: none; padding: 0;" class="text-left">
                    ...
                    <div class="outlet-info"><?php echo e($outlet_name ?? 'Pertashop'); ?> • Periode: <?php echo e($period ?? 'Bulan Berjalan'); ?></div>
                </td>
                <td style="border: none; padding: 0; width: 140px;" class="text-right">
                    <div style="display: inline-block; background: #0f4c81; color: #fff; padding: 4px 8px; border-radius: 3px; font-weight: bold; font-size: 8pt;">
                        HALAMAN 2
        ...
        <tr>
            <td style="border: none; padding: 0 5px 0 0; width: 33.3%;">
                <div class="card">
                    ...
                    <div class="font-bold" style="font-size: 10pt; color: #0f4c81;">Rp <?php echo e(number_format($laba_kotor ?? 0, 0, ',', '.')); ?></div>
                </div>
            </td>
            <td style="border: none; padding: 0 5px; width: 33.3%;">
                <div class="card">
                    <div class="card-title">B. Total Beban Biaya</div>
                    <div class="font-bold" style="font-size: 10pt; color: #b91c1c;">Rp <?php echo e(number_format($total_beban ?? 0, 0, ',', '.')); ?></div>
                </div>
            </td>
            <td style="border: none; padding: 0 0 0 5px; width: 33.3%;">
                <div class="card card-highlight">
                    <div class="card-title" style="color: #166534;">C. Laba Bersih (A - B)</div>
                    <div class="font-bold" style="font-size: 10pt; color: #166534;">Rp <?php echo e(number_format($laba_bersih ?? 0, 0, ',', '.')); ?></div>
                </div>
            </td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            ?>
            <?php $__currentLoopData = $expenses_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="text-center"><?php echo e($idx + 1); ?></td>
                    <td><?php echo e($exp['name']); ?></td>
                    <td class="text-right">Rp <?php echo e(number_format($exp['amount'] ?? 0, 0, ',', '.')); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr class="table-total">
                <td colspan="2" class="text-right">TOTAL BEBAN OPERASIONAL (B)</td>
                <td class="text-right" style="color: #b91c1c;">Rp <?php echo e(number_format($total_beban ?? 0, 0, ',', '.')); ?></td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="card mb-3" style="background: #f8fafc;">
        <table style="margin: 0; font-size: 8pt;">
            <tr>
                ...
                <td style="border: none; padding: 3px 0;" class="text-right font-bold">Rp <?php echo e(number_format($alokasi_modal ?? (($laba_bersih ?? 0) * 0.1), 0, ',', '.')); ?></td>
            </tr>
            <tr>
                <td style="border: none; padding: 3px 0; color: #166534;">• Saldo Laba Bersih yang Siap Dibagi ke Investor (90%)</td>
                <td style="border: none; padding: 3px 0; color: #166534;" class="text-right font-bold">Rp <?php echo e(number_format($saldo_dibagi ?? (($laba_bersih ?? 0) * 0.9), 0, ',', '.')); ?></td>
            </tr>
        </table>
    </div>
    ...
    <table>
        ...
        <tbody>
            <?php if(isset($investors) && count($investors) > 0): ?>
                <?php $__currentLoopData = $investors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center"><?php echo e($i + 1); ?></td>
                        <td class="font-bold"><?php echo e($inv['name']); ?></td>
                        <td class="text-center"><?php echo e($inv['percentage']); ?>%</td>
                        <td class="text-right font-bold">Rp <?php echo e(number_format($inv['amount'] ?? 0, 0, ',', '.')); ?></td>
                        <td><?php echo e($inv['bank'] ?? 'Bank'); ?> - <?php echo e($inv['account_number'] ?? '-'); ?></td>
            ...
            <?php else: ?>
                <tr>
                    ...
                    <td class="text-right font-bold">Rp <?php echo e(number_format($saldo_dibagi ?? 0, 0, ',', '.')); ?></td>
        ...
        <table class="signature-table">
            <tr>
                <td style="width: 33%;">
                    ...
                    <div class="sign-line"><?php echo e($admin_name ?? 'Dwi Yuliarto'); ?></div>
                </td>
                <td style="width: 33%;">
                    <div>Mengetahui,</div>
        ...
        <table style="margin: 0; border: none;">
            <tr>
                <td style="border: none; padding: 0;" class="text-left">
                    ...
                    <div class="outlet-info"><?php echo e($outlet_name ?? 'Pertashop'); ?> • Posisi Periode: <?php echo e($period ?? 'Bulan Berjalan'); ?></div>
                </td>
                <td style="border: none; padding: 0; width: 140px;" class="text-right">
                    <div style="display: inline-block; background: #0f4c81; color: #fff; padding: 4px 8px; border-radius: 3px; font-weight: bold; font-size: 8pt;">
                        HALAMAN 3
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right">Rp <?php echo e(number_format($aset_do ?? 0, 0, ',', '.')); ?></td>
                        </tr>
                        <tr>
                            <td>2. Saldo Kas di Bank</td>
                            <td class="text-right">Rp <?php echo e(number_format($aset_bank ?? 0, 0, ',', '.')); ?></td>
                        </tr>
                        <tr>
                            <td>3. Kas Kecil di Outlet (Tunai)</td>
                            <td class="text-right">Rp <?php echo e(number_format($aset_kas ?? 0, 0, ',', '.')); ?></td>
                        </tr>
                        <tr>
                            <td>4. Valuasi Fisik Sisa BBM</td>
                            <td class="text-right">Rp <?php echo e(number_format($aset_stok ?? 0, 0, ',', '.')); ?></td>
                        </tr>
                        <tr>
                            <td>5. Hasil Jual Belum Setor</td>
                            <td class="text-right">Rp <?php echo e(number_format($aset_belum_setor ?? 0, 0, ',', '.')); ?></td>
                        </tr>
                        <tr>
                            <td>6. Piutang Usaha</td>
                            <td class="text-right">Rp <?php echo e(number_format($aset_piutang ?? 0, 0, ',', '.')); ?></td>
                        </tr>
                        <tr class="table-total">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right font-bold">Rp <?php echo e(number_format($modal_awal ?? 60000000, 0, ',', '.')); ?></td>
                        </tr>
                        <tr>
                            <td>• Bunga Bank Periode Ini (+)</td>
                            <td class="text-right">Rp <?php echo e(number_format($bunga_bank ?? 0, 0, ',', '.')); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right" style="color: #166534;">Rp <?php echo e(number_format($alokasi_modal ?? 0, 0, ',', '.')); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr class="table-total" style="background: #f0fdf4;">
                            ...
                            <td class="text-right font-bold" style="color: #166534;">Rp <?php echo e(number_format($modal_akhir ?? ($modal_awal ?? 60000000) + ($alokasi_modal ?? 0), 0, ',', '.')); ?></td>
                        </tr>
                    </tbody>
                </table>
            </td>
    ...
    <table>
        ...
        <tbody>
            <?php if(isset($modal_history) && count($modal_history) > 0): ?>
                <?php $__currentLoopData = $modal_history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $hist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center"><?php echo e($idx + 1); ?></td>

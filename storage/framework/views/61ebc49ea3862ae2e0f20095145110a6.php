...
<title>Pertashop App — <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
<link rel="stylesheet" href="<?php echo e(asset('css/sidebar-only.css')); ?>?v=<?php echo e(time()); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/new-admin.css')); ?>?v=<?php echo e(time()); ?>">
  ...
  <div class="main">
    <div class="topbar">
      <div class="d-flex align-items-center">
        ...
        <div class="crumbs">Home <span style="opacity:.5">/</span> <b><?php echo $__env->yieldContent('title', 'Dashboard'); ?></b></div>
      </div>
      <div class="badge-pill"><?php echo e(Auth::user()->role ?? 'SUPER ADMIN'); ?></div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\Pertashop App_Laravel\sal-pertashop\resources\views/layouts/_new_admin.blade.php ENDPATH**/ ?>